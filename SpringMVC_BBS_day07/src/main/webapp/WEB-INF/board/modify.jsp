	...
	<div class="w-50 border rounded px-5 py-5 shadow"">
		<form method="post" action="<c:url value='modify.do'/>">
		  ...
		  <div class="text-center">
		  	...
		  	<button type="button" id="remove" class="btn btn-info mr-2">삭제</button>
...
<script type="text/javascript">
	$(document).ready(()=>{
		...
		$("#remove").click(()=>{
			location.href="<c:url value='/remove.do'/>?bid=${board.bid}&viewPage=${viewPage}&searchType=${searchType}&keyWord=${keyWord}&totalCnt=${totalCnt}";
		});
	});
</script></body>
</html>